/**
 * Unit tests for command definitions - standalone tests that don't require VSCode
 */
...
describe('Command Definition Unit Tests', () => {
  ...
  it('should return correct command with getCommandDefinition', () => {
  ...
  it('should return correct operation with getOperationDefinition', () => {
  ...
  it('should return operation names for command', () => {
  ...
  it('should have expected verilator operations', () => {
    const verilatorCmd = getCommandDefinition('verilator');
  ...
  it('should have job argument in build operations', () => {
    ...
    [verilatorBuild, vcsBuild].forEach((buildOp, index) => {
      ...
      const jobArg = buildOp.arguments.find((arg: any) => arg.name === 'job');
  ...
  it('should have binary and batch arguments in sim operations', () => {
    ...
    [verilatorSim, vcsSim].forEach((simOp, index) => {
      ...
      const binaryArg = simOp.arguments.find((arg: any) => arg.name === 'binary');
      ...
      const batchArg = simOp.arguments.find((arg: any) => arg.name === 'batch');
  ...
  it('should have valid choices for choice arguments', () => {
    const workloadRun = getOperationDefinition('workload', 'run');
    assert.ok(workloadRun, 'Workload run operation should exist');
    
    const simulatorArg = workloadRun.arguments.find((arg: any) => arg.name === 'simulator');
  ...
  it('should have server operations for agent command', () => {
    ...
    const portArg = startOp.arguments.find((arg: any) => arg.name === 'port');
  ...
  it('should have proper file and directory argument types', () => {
    ...
    const inputArg = marshalPack.arguments.find((arg: any) => arg.name === 'input');
    const outputArg = marshalPack.arguments.find((arg: any) => arg.name === 'output');
